...
<div id="container">
    ...
    <div class="form_container">
        <form action="${pageContext.request.contextPath}/normal/pub_article" onsubmit="return check()" method="post">
            <div class="article_title">
                <label style="display: flex; flex-direction: row; flex-wrap: nowrap">
                    帖子标题:
                        <input style="flex-grow: 1" type="text" name="article_title" minlength="5" maxlength="50" width="100%" required>
                </label>
                ...
                <label>
                    <input class="bt" type="submit" value="立即发布">
                    <label id="tips"></label>
                </label>
            </div>
        </form>
